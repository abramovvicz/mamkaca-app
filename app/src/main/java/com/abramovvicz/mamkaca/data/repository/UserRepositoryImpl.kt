...
class UserRepositoryImpl : UserRepository {
    ...
    override suspend fun saveUser(user: User): Flow<User> = flow {
        ...
        try {
            ...
            val updatedUser = user.copy(updatedAt = ZonedDateTime.now().toString())
...
//                    onConflict("id")
     ...
     */
    override suspend fun updateLastDrinkingDate(userId: String, lastDrinkingDate: String): Flow<User> = flow {
        validateUserId(userId)
