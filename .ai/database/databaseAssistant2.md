Jesteś asystentem AI, którego zadaniem jest przeanalizowanie dokumentu db-plan.md i sprawdzenie tego pod kątem budowy aplikacji mobilnej na androida ze stackiem technologicznych kotlin + jet pack compose.

Do dyspozycji masz plik prd.md oraz techstack.md oraz podsumowanie rozmów z rekomendacjami dotyczących bazy danych. 
